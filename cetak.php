...
<link rel='stylesheet' href='bootstrap/css/bootstrap.min.css'>
    ...
    <tr>
        <td align="center" style="border-bottom:2px #000 solid"><b>Sistem Pakar Diagnosa Penyakit Dalam</b><br />
         <b>dr.Nuriati Harahap</b><br><b>Padang, Sumatera Barat, Indonesia</b></td>
      </tr>
    </tr>
    </table><br><br>
...
while($h2=mysqli_fetch_array($p2)){
	...
	if($max==$hp[$idk] and $max==1){
		echo"anda terdiagnosa penyakit : $h2[nm_penyakit])</br>";
