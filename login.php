...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if($_POST['level']==1){
		$kueri = mysqli_query($koneksi, "select * from admin where username='$username';");
	}else{
	$kueri = mysqli_query($koneksi, "select * from tbuser where username='$username';");
	}
	...
	else $pesan = pesan('danger',"Username dan Password tidak cocok.",0);
}
else $pesan="";
head('Login',1);
style(1); ?>
